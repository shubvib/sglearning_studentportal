...
const BannedPriviewMdal = (props) => {
    const {
        ...
        isMockTest = false,
        showBannedPriviewModal, handleCloseBannedPriviewModal, data, remainingDurationTime//new props
    } = props;
    ...
    return (
        ...
        <div className="modal-main-dark">
            <Modal show={showBannedPriviewModal} onHide={() => {
                if (!examCompleted) {
                    handleCloseBannedPriviewModal()
                }
                ...
                <Modal.Header >
                    <div className="modal-title-box">
                        <h3><GrDocumentStore size={26} />Due To Violation Of Terms, Your Exam Submited</h3>
                    </div>
                </Modal.Header>
                <Modal.Body>
                    <div className="subject-mapping-wrapper" style={{
                    ...
                    }}>
                        {
                            <div className="instruction-timer-wrapper" >
                                <span className="time-remain-text">Exam submited in </span>
...
export default connect(mapPropsToState)(BannedPriviewMdal);
